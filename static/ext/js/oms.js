...
(function() {
  var oms, use_define, _ref,
    __hasProp = {}.hasOwnProperty,
    __slice = [].slice;

  use_define = this.define && this.define.amd;

  if (!(use_define || (((_ref = this['google']) != null ? _ref['maps'] : void 0) != null))) {
    return;
  }

  oms = function(ctx) {
    return ctx['OverlappingMarkerSpiderfier'] = (function() {
  ...
  if (use_define) {
    define('oms', ['google'], function(google) {
      return oms({
        google: google
      });
    });
